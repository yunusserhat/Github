...
linkTitle: "Kariyer Planlama"
summary: "T.C. Cumhurbaşkanlığı İnsan Kaynakları Ofisi Kariyer Planlama Dersi Yönergesi ve Platform Kılavuzuna uygun haftalık ders izlencesi, zorunlu video takvimi, öz farkındalık, sektör tanıtımları ve kariyer yönetimi rehberi."
type: book
course_codes:
  - "KPD1001"
  - "YZM2053"
...
```mermaid
graph TD
    A["e-Devlet ile Giriş<br>(kariyerplanlama.gov.tr)"] --> B["Ders ve Öğretim Elemanı Seçimi"]
    B --> C["Haftalık Eğitim Takvimi Takibi"]
    C --> D["* Zorunlu Videoları Eksiksiz İzleme"]
    C --> E["Haftalık Etkinlikleri & Notları Tamamlama"]
    D --> F["Ders Sonu Değerleme Formu"]
    E --> F
    F --> G["Resmi Katılım Belgesi & Başarılı Tamamlama"]
```
...
| **1** | [Kariyer Yolculuğun Başladı: İlk Durak Kariyer Merkezi](hafta-01) | *Kariyer Planlama Dersi tanıtım videosu<br>*Kariyer Merkezi faaliyetleri tanıtım videoları | 🟢 Açık |
...
| **6** | [Kariyerime Nasıl Hazırlanırım?](hafta-06) | *Kariyerime katkı sağlayacak faaliyetler videosu<br>*Faaliyet tanıtım videoları (Ders dışı etkinlikler, Erasmus) | 🟢 Açık |
...
| **14** | [İş Dünyasına İlk Adım: Öz Geçmiş & Profesyonel İmaj](hafta-14) | *Öz geçmiş hazırlama ve dijital profesyonel kimlik videosu<br>Ders Sonu Değerleme Formu | 🟢 Açık |
...
{{< cta cta_text="📖 Platform Rehberi ve Giriş ile Başla" cta_link="giris" >}}
